::  thought: imperial thought for the day
::  via https://wh40k.lexicanum.com/wiki/Thought_for_the_day
|%
++  thought
  ^-  (list @t)
  :~
    ...
    'Burn the heretic.'
    'Burn the Heretic!\0aKill the Mutant!\0aPurge the Unclean!'
    ...
    'Only the insane have strength enough to prosper;\0aonly those that prosper truly judge what is sane.'
    ...
    'Praise the sun that brings the dawn\0aOf our final doom.'
    ...
    'Speed the bolt that brings the end\0aOf enemy and friend.'
    ...
    'The enemies of the Emperor fear many things.\0aThey fear discovery, defeat, despair and death.\0aYet there is one thing they fear above all others.\0aThey fear the wrath of the Space Marines!'
    ...
    'The weapon slays where the hand wills\0aServe the Emperor!'
    ...
    'There is no time for Peace.\0aNo respite\0aNo forgiveness\0aThere is only WAR!'
    ...
    'Though silver in your palms weighs light\0aCompared to death by blast and sword,\0aDo not shy the hopeless fight,\0aFor endeavour is its own reward.'
    ...
    'Vengeance is your sword.<br>Hatred is your shield.<br>Loyalty is your Armour.'
    ...
    'We shall carry our word,\0aWe will correct and unify,\0aHail the Emperor!'
    'Weigh the fist that strikes men down\0aAnd salutes the battle won.'
    ...
    'What is the terror of death?\0aThat we die our work incomplete.\0aWhat is the joy of life?\0aTo die knowing our task is done.'
    'What is your life?\0aMy honour is my life.\0aWhat is your fate?\0aMy duty is my fate.\0aWhat is your fear?\0aMy fear is to fall.\0aWhat is your reward?\0aMy salvation is my reward.\0aWhat is your craft?\0aMy craft is death.\0aWhat is your pledge?\0aMy pledge is eternal service.'
